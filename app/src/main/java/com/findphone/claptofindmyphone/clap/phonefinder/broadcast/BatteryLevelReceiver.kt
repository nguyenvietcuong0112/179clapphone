...
import com.findphone.claptofindmyphone.clap.phonefinder.model.AlarmState
...
class BatteryLevelReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        } else if (action == "com.finder.clap.findphone.whistle.byclapping.ACTION_STOP_FULL_BATTERY_ALARM") {
            stopBatteryAlarm(context, AlarmType.BATTERY_FULL)
        } else if (action == "com.finder.clap.findphone.whistle.byclapping.ACTION_STOP_LOW_BATTERY_ALARM") {
    ...
    private fun checkBatteryAlarms(context: Context, batteryPercentage: Int) {
        ...
        Log.d("tƯỜNG", AlarmType.values().size.toString() + "")
